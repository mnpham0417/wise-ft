...
singularity exec --nv \
  ...
  /bin/bash -c 'source /ext3/env.sh; conda activate /scratch/mp5847/conda_environments/conda_pkgs/wise_ft; cd /home/mp5847/src/wise-ft; export PYTHONPATH="$PYTHONPATH:$PWD"; \
      torchrun src/train_kd_ce_hardlabels.py --name "rn50_scratch_0" \
                            --epochs 100 \
                            --learning_rate 0.1 \
                            --cuda \
                            --workers 5 \
                            ...
                            --T 1.0 \
                            --resume \
                            --pretrained-ckpt "/scratch/mp5847/wise-ft-kd/rn50_scratch_0/model_37.pt" \
                            --optimizer-ckpt "/scratch/mp5847/wise-ft-kd/rn50_scratch_0/optimizer_37.pt" \
                            --scheduler-ckpt "/scratch/mp5847/wise-ft-kd/rn50_scratch_0/scheduler_37.pt" \
                            --start-epoch 38'
