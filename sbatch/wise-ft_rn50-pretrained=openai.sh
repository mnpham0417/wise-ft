...
#SBATCH --output=wise-ft_RN50-pretrained=openai_%j.out
...
singularity exec --nv \
  ...
  --overlay /vast/work/pulic/ml-datasets/imagenet/imagenet-train.sqf:ro \
  ...
  /bin/bash -c 'source /ext3/env.sh; conda activate /scratch/mp5847/src/comp_exp; cd /home/mp5847/src/wise-ft; export PYTHONPATH="$PYTHONPATH:$PWD"; \
      python src/wise_ft.py   \
        ...
        --save=/scratch/mp5847/wise-ft-ckpt/RN50-pretrained=openai  \
        --data-location=/ \
