...
def finetune(args):
    ...
    #             logits = model(inputs)
    #         except:
    #             #print device of inputs
    #             print('Inputs are on device:', inputs.device)
    ...
    #     #move model parallel back to gpus
    #     #TODO: For some reason after saving the model got moved to CPU, so we need to move it back to GPU
    #     model = model.module
    #     model = torch.nn.DataParallel(model, device_ids=devices)
